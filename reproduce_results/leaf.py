...
concatenated.to_excel('concatenated_leaf.xlsx')
...
for miss in missing:
    for k in ks:
        ...
        m_result = cross_validate(multiclassM, X_missing, y, scoring='roc_auc_ovo', return_estimator=True, cv=2)
        ...
        ind += 1
concatenated = pd.concat(dfs)
concatenated.to_excel('concatenated_leaf_m.xlsx')
