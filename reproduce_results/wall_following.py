...
wifi = pd.read_csv(pth.concatenate_path_os_independent('sensor_readings_4.data'), header=None)
...
concatenated.to_excel('concatenated_wall.xlsx')
...
for miss in missing:
    for k in ks:
        ...
        ind += 1
concatenated = pd.concat(dfs)
concatenated.to_excel('concatenated_wall_m.xlsx')
